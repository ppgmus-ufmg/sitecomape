...
// por item do Informativo, sem combinar itens adjacentes num mesmo
// slide. O item "Plataforma Sucupira/Censo da CAPES" foi acrescentado
// depois, a pedido da Coordenação — não está no PDF original.
//
// Numeração: os títulos usam o número de ORDEM DE APRESENTAÇÃO (1 a 15),
// não o número original do Informativo — a seção "Antes de Tudo" (Lattes
// e Censo da CAPES) foi movida para o início a pedido da Coordenação,
// então renumerar era necessário pra manter a sequência 1..N sem saltos.
//
    ...
    "sections": [
      {
        "id": "sec0-lattes",
        "title": "Antes de Tudo",
        "resumo": "Os hábitos mais importantes para toda a sua trajetória no Programa (itens 1-2).",
        "slides": [
          {
            "id": "0a",
            "kind": "concept",
            "title": "1 · Mantenha o Lattes sempre atualizado",
            "body": [
          ...
          },
          {
            "id": "0b",
            "kind": "concept",
            "title": "2 · Plataforma Sucupira e Censo da Pós-Graduação",
            "body": [
      ...
      },
      {
        ...
        "resumo": "Duração, matrícula, estrutura curricular e aproveitamento de créditos (itens 3-6).",
        "slides": [
          {
            "id": "1a",
            "kind": "concept",
            "title": "3 · Duração do curso (mestrado e doutorado)",
            "body": [
          ...
          },
          {
            "id": "1b",
            "kind": "concept",
            "title": "4 · Matrícula semestral obrigatória",
            "body": [
          ...
          },
          {
            "id": "1c",
            "kind": "concept",
            "title": "5 · Estrutura curricular e créditos",
            "body": [
          ...
          },
          {
            "id": "1d",
            "kind": "concept",
            "title": "6 · Aproveitamento de disciplina/crédito",
            "body": [
      ...
      },
      {
        ...
        "title": "Financiamento",
        "resumo": "Auxílio financeiro para eventos/campo e bolsas de estudo do Programa (itens 7-8).",
        "slides": [
          {
            "id": "2a",
            "kind": "concept",
            "title": "7 · Auxílio financeiro",
            "body": [
      ...
      },
      {
        ...
        "resumo": "Estágio-docência, 2ª língua, recital, qualificação, portfólio e defesa (itens 9-14).",
        "slides": [
          {
            "id": "3a",
            "kind": "concept",
            "title": "9 · Estágio-docência",
            "body": [
          ...
          },
          {
            "id": "3b",
            "kind": "concept",
            "title": "10 · Proficiência em 2ª língua estrangeira",
            "body": [
          ...
          },
          {
            "id": "3c",
            "kind": "concept",
            "title": "11 · Recital de Prática Instrumental Avançada II",
            "body": [
          ...
          },
          {
            "id": "3d",
            "kind": "concept",
            "title": "12 · Exame de Qualificação",
            "body": [
          ...
          },
          {
            "id": "3e",
            "kind": "concept",
            "title": "13 · Portfólio de produção intelectual",
            "body": [
          ...
          },
          {
            "id": "3f",
            "kind": "concept",
            "title": "14 · Defesa de Dissertação/Tese",
            "body": [
      ...
      },
      {
        ...
        "resumo": "Bolsa CAPES/PDSE para estágio no exterior (item 15).",
        "slides": [
          {
            "id": "4a",
            "kind": "concept",
            "title": "15 · Doutorado sanduíche (PDSE)",
            "body": [
